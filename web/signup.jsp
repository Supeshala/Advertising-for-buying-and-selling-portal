<%-- 
    Document   : signup
    Created on : Jan 25, 2018, 12:29:31 PM
    Author     : HP
--%>
...
<html>
    ...
    <body>
        ...
        <div class="w3layouts-breadcrumbs text-center">
            <div class="container">
                <span class="agile-breadcrumbs"><a href="index.jsp"><i class="fa fa-home home_1"></i></a> / <span>Sign Up</span></span>
            </div>
        </div>
        <!-- //breadcrumbs -->
        <!-- sign up form -->
            ...
            <div id="agileits-sign-in-page" class="sign-in-wrapper">
                <div class="agileinfo_signin">
                    ...
                    <form name="signup" action="SignUp" method="post" >
                        ...
                        <input type="tel" name="tel" placeholder="Mobile(x xxx xxx xxx)" required="" pattern="[0-9]{10}"> 
