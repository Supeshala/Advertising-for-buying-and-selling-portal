            ...
            <div class="container">
                <div class="agile-its-header">
                    ...
                    <div class="agileits_search">
                        ...
                        <% Criteria cr1 = ses.createCriteria(User.class).add(Restrictions.eq("email", request.getSession().getAttribute("User_Email").toString()));
                               User us1 = (User) cr1.uniqueResult();%>
