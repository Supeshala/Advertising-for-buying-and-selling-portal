<%-- 
    Document   : terms
    Created on : Apr 9, 2018, 8:11:21 PM
    Author     : HP
--%>
...
<head>
    ...
    <title>Terms of Use :: Sellit  </title>
...
<body>	
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.jsp"><i class="fa fa-home home_1"></i></a> / <span>Terms of Use</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
    <!-- Terms of use -->
				...
				<!-- First Panel -->
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								<p>The advertisements that you are posting is manually reviewed by a team and sellit has the ability to decide whether they are complied with our rules or not. We have the right to accept or reject advertisements.   </p>
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse">
							<div class="panel-body">								
								<p>Advertisers and users are responsible to make sure that the advertising contents and images that you are uploading are complied with all applicable laws. </p>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseThree">
								<span>3.</span> Watermarks and Safety Images
							 </h4>
						</div>
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Advertisers are not allowed to use images with watermarks. If not, we have the ability to reject your advertisements.</p>
                                                                <p>Sellit has the right not to publish irrelevant images.</p>
							</div>
						</div>
					</div>
					<!-- Fourth Panel -->
					<div class="panel panel-default">
						<div class="panel-heading">
							 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseFour">
								<span>4.</span> Posting Ads
							 </h4>
						</div>
						<div id="collapseFour" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Make sure you post the advertisement under the right category. Before you post your advertisements, it is recommended to refer sellit sitemap. </p>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseFive">
								<span>5.</span> Advertiser's Location
							 </h4>
						</div>
						<div id="collapseFive" class="panel-collapse collapse">
							<div class="panel-body">
								<p>Before you post your advertisement, it is better if you can refer sellit locations map.</p>
                                                                <p>Select your current location. If your location is not available in our locations list, you have to select the closest location.</p>
							</div>
						</div>
					</div>
					<!-- Sixth Panel -->
					<div class="panel panel-default">
						<div class="panel-heading">
							 <h4 class="panel-title" data-toggle="collapse" data-target="#collapseSix">
								<span>6.</span> Posting advertisements violations
							 </h4>
						</div>
						<div id="collapseSix" class="panel-collapse collapse">
							<div class="panel-body">
								<p>The advertisers are not allowed to post the same post more than once. Kindly note that duplicate advertisements are rejected.</p>
