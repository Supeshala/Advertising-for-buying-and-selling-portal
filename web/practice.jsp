                                ...
                                <form action="PostAd" method="post" enctype="multipart/form-data">
                                    <div class="category">
                                        ...
                                        <div class="sell-details">
                                            ...
                                            <select required name="brand">
                                                ...
                                                <optgroup label="Mobile Phones"></optgroup>
                                                ...
                                                <option>Asus</option>
                                                <optgroup label="Accessories"></optgroup>
                                    ...
                                    <div class="upload-ad-photos">
                                        ...
                                        <div class="photos-upload-view">
                                            <div>
                                                <div class="col-md-6">
                                                    <img id="output" style="width: 200px; height: 200px; " src="images/default-store.jpg"/>
                                                    <input type="hidden" id="MAX_FILE_SIZE" name="MAX_FILE_SIZE" value="300000" />

                                                    <div>
                                                        <input type="file" id="fileselect" onchange="loadFile(event)" name="image" multiple="multiple" required=""/>

                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <img id="output1" style="width: 200px; height: 200px; " src="images/default-store.jpg"/>
                                                    <input type="hidden" id="MAX_FILE_SIZE" name="MAX_FILE_SIZE" value="300000" />

                                                    <div>
                                                        <input type="file" id="fileselect" onchange="loadFile1(event)" name="image1" multiple="multiple" required=""/>
                                            ...
                                            <div>
                                                <div class="col-md-6">
                                                    <img id="output2" style="width: 200px; height: 200px; " src="images/default-store.jpg"/>
                                                    <input type="hidden" id="MAX_FILE_SIZE" name="MAX_FILE_SIZE" value="300000" />

                                                    <div>
                                                        <input type="file" id="fileselect" onchange="loadFile2(event)" name="image2" multiple="multiple" required=""/>

                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <img id="output3" style="width: 200px; height: 200px; " src="images/default-store.jpg"/>
                                                    <input type="hidden" id="MAX_FILE_SIZE" name="MAX_FILE_SIZE" value="300000" />

                                                    <div>
                                                        <input type="file" id="fileselect" onchange="loadFile3(event)" name="image3" multiple="multiple" required=""/>
