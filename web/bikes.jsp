                            ...
                            <div class="search">
                                <div id="custom-search-input">
                                    <div class="input-group">
                                        <input type="text" name="sproduct" class="form-control input-lg" placeholder="Yamaha" />
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div>
                                            <div id="container">
                                                ...
                                                <div class="clearfix"></div>
                                                <% Criteria cr = ses.createCriteria(Ad.class).add(Restrictions.eq("category", "Bikes")); %>
