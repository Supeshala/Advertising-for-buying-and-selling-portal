<%-- 
    ...
    Created on : Feb 17, 2018, 10:38:32 PM
    Author     : HP
--%>
...
<html>
    <head>
        <title>All Classifieds :: Sellit</title>
        ...
        <script src="js/bootstrap.min.js"></script><script src="js/bootstrap-select.js"></script>
        <script type="text/javascript">
            ...
            <div class="w3ls-header"><!--header-one--> 
                ...
                <div class="w3ls-header-right">
                    <ul>
                        ...
                        <li class="dropdown head-dpdn">
                            <a href="profile.jsp" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> My Profile</a>
                        </li>
                        <li class="dropdown head-dpdn">
            ...
            <div class="container">
                ...
                <div class="all-categories">
                    ...
                    <ul class="all-cat-list">
                        <li><a href="mobiles.jsp">Mobiles <span class="num-of-ads"></span></a></li>
                        <li><a href="electronics-appliances.jsp">Electronics & Appliances  <span class="num-of-ads"></span></a></li>
                        <li><a href="real-estate.jsp">Real Estate  <span class="num-of-ads"></span></a></li>
                        <li><a href="furnitures.jsp">Furniture    <span class="num-of-ads"></span></a></li>
                        <li><a href="pets.jsp">Pets   <span class="num-of-ads"></span></a></li>
                        <li><a href="books-sports-hobbies.jsp">Books, Sports & Hobbies    <span class="num-of-ads"></span></a></li>
                        <li><a href="fashion.jsp">Fashion   <span class="num-of-ads"></span></a></li>
                        <li><a href="kids.jsp">Kids   <span class="num-of-ads"></span></a></li>
                        <li><a href="services.jsp">Services   <span class="num-of-ads"></span></a></li>
                        <li><a href="cars.jsp">Cars   <span class="num-of-ads"></span></a></li>
                        <li><a href="bikes.jsp">Bikes   <span class="num-of-ads"></span></a></li>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div>
                                            <div id="container">
                                                ...
                                                <div class="clearfix"></div>
                                                <% Criteria cr = ses.createCriteria(Ad.class).addOrder(Order.desc("date")); %>
