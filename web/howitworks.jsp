<%-- 
    Document   : howitworks
    Created on : Apr 9, 2018, 6:57:34 PM
    Author     : HP
--%>
...
<head>
    ...
    <title>How it works :: Sellit  </title>
...
<body>	
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.jsp"><i class="fa fa-home home_1"></i></a> / <span>How it Works</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
    <!-- How it works -->
				...
				<h2 class="w3-head">How It Works</h2>
					...
					<div class="work-section-grids text-center">
						<div class="col-md-3 work-section-grid">
							...
							<h4>Post an Ad</h4>
							<p>If you have any product or service, you just want to sign in to the site and post your advertisement under the correct category.</p>
							<span class="arrow1"><img src="images/arrow1.png" alt="" /></span>
						</div>
						<div class="col-md-3 work-section-grid">
							<i class="fa fa-eye"></i>
							<h4>Find an item</h4>
							<p>If you want to buy any product or service, you simply want to look for the specific product under the correct category.</p>
							<span class="arrow2"><img src="images/arrow2.png" alt="" /></span>
						</div>
						<div class="col-md-3 work-section-grid">
							<i class="fa fa-phone"></i>
							<h4>contact the seller</h4>
							<p>If you are interested in any of the mentioned product, you simply need to contact the seller.</p>
							<span class="arrow1"><img src="images/arrow1.png" alt="" /></span>
						</div>
						<div class="col-md-3 work-section-grid">
							<i class="fa fa-money"></i>
							<h4>make transactions</h4>
							<p>Make your transactions as the final stage.</p>
						</div>
						<div class="clearfix"></div>
                    ...
                    <% Criteria cr = ses.createCriteria(User.class).add(Restrictions.eq("email", request.getSession().getAttribute("User_Email").toString()));
                            User us = (User) cr.uniqueResult();%>
                    <a class="work" href="post-ad.jsp">Get start Now</a>
                    <% } else { %>
                    <a class="work" href="signin.jsp">Get start Now</a>
                    <% }
