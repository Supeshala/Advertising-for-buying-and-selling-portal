...
<html>
    <head>
        <title>Books, Sports & Hobbies :: Sellit</title>
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			...
			<span>Books, Sports & Hobbies</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                        <div>
                                            <div id="container">
                                                ...
                                                <div class="clearfix"></div>
                                                <% Criteria cr = ses.createCriteria(Ad.class).add(Restrictions.eq("category", "Books, Sports and hobbies")); %>
